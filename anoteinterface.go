...
// // Forward is a paid mutator transaction binding the contract method 0xfd078c1d.
// //
// // Solidity: function forward(string to, uint256 amount) returns()
// func (_Token *TokenTransactor) Forward(opts *bind.TransactOpts, to string, amount *big.Int) (*types.Transaction, error) {
// 	return _Token.contract.Transact(opts, "forward", to, amount)
// }

// // Forward is a paid mutator transaction binding the contract method 0xfd078c1d.
// //
// // Solidity: function forward(string to, uint256 amount) returns()
// func (_Token *TokenSession) Forward(to string, amount *big.Int) (*types.Transaction, error) {
// 	return _Token.Contract.Forward(&_Token.TransactOpts, to, amount)
// }

// // Forward is a paid mutator transaction binding the contract method 0xfd078c1d.
// //
// // Solidity: function forward(string to, uint256 amount) returns()
// func (_Token *TokenTransactorSession) Forward(to string, amount *big.Int) (*types.Transaction, error) {
// 	return _Token.Contract.Forward(&_Token.TransactOpts, to, amount)
// }
